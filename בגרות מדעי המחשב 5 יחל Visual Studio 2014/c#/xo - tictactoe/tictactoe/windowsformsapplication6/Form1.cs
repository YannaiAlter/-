...
namespace WindowsFormsApplication6
{
    public partial class Form1 : Form
    {
        ...
        public bool WinOrBlock()
        {
            ...
            int best = 500; // 1 - O Wins, 2 - O Blocks one step between two x,3- special situation, 4 - O put 1 between two Os, 5- O put 1 near 1 O. 6-O put 1 near one O 7 - O blocks between 2 X 8 - O Blocks near x 9- O block near X
                ...
                for (int j = 0; j < a_XOstatus1.GetLength(1); j++)
                {
                    ...
                    else if (!a_XOstatus1[i, j].Contains('X') && a_XOstatus1[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            if (a_Tafoos[i + k, j - k + v_Sequence - 1] == null)
                            {
                                ...
                                if (((i + k - 1 >= 0 && i + k + 1 < a_Tafoos.GetLength(0) && j - k + 1 + v_Sequence - 1 < a_Tafoos.GetLength(1) && j - k - 1 + v_Sequence - 1 >= 0 && a_Tafoos[i + k - 1, j - k + 1 + v_Sequence - 1] == "O" && a_Tafoos[i + k + 1, j - k - 1 + v_Sequence - 1] == "O")))
                                {
                                    if (best > 4)
                                    {
                                        best = 4;
                                ...
                                else if (i + k + 1 < a_Tafoos.GetLength(0) && j - k - 1 + v_Sequence - 1 >= 0 && a_Tafoos[i + k + 1, j - k - 1 + v_Sequence - 1] == "O")
                                {
                                    if (best > 6)
                                    {
                                        best = 6;
                    ...
                    else if (!a_XOstatus1[i, j].Contains('O') && a_XOstatus1[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            ...
                            if (a_Tafoos[i + k, j - k + v_Sequence - 1] == null)
                            {
                                if (((i + k - 1 >= 0 && i + k + 1 < a_Tafoos.GetLength(0) && j - k + 1 + v_Sequence - 1 < a_Tafoos.GetLength(1) && j - k - 1 + v_Sequence - 1 >= 0 && a_Tafoos[i + k - 1, j - k + 1 + v_Sequence - 1] == "X" && a_Tafoos[i + k + 1, j - k - 1 + v_Sequence - 1] == "X")))
                            {
                                if (best > 7)
                                {
                                    best = 7;
                             ...
                             else   if (i + k + 1 < a_Tafoos.GetLength(0) && j - k - 1 + v_Sequence - 1 >= 0 && a_Tafoos[i + k + 1, j - k - 1 + v_Sequence - 1] == "X")
                                {
                                    if (best > 8)
                                    {
                                        best = 8;
                ...
                for (int j = 0; j < a_XOstatus2.GetLength(1); j++)
                {
                    ...
                    else if (!a_XOstatus2[i, j].Contains('X') && a_XOstatus2[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            if (a_Tafoos[i + k, j] == null)
                            {
                         if (i + k + 1 < a_Tafoos.GetLength(0) && i + k - 1 >= 0 && a_Tafoos[i + k + 1, j] == "O" && a_Tafoos[i + k - 1, j] == "O")
                                {
                                    if (best > 4)
                                    {
                                        best = 4;
                                ...
                                else  if (i + k + 1 < a_Tafoos.GetLength(0) && a_Tafoos[i + k + 1, j] == "O")
                                {
                                    if (best > 6)
                                    {
                                        best = 6;
                    ...
                    else if (!a_XOstatus2[i, j].Contains('O') && a_XOstatus2[i, j].Length == v_Sequence - 2)
                    {
                        ...
                        {
                            if (a_Tafoos[i + k, j] == null)
                            {          if (i + k + 1 < a_Tafoos.GetLength(0) && i + k - 1 >= 0 && a_Tafoos[i + k + 1, j] == "X" && a_Tafoos[i + k - 1, j] == "X")
                                {
                                    if (best > 7)
                                    { 
                                        best =7;
                               ...
                               else if (i + k + 1 < a_Tafoos.GetLength(0) && a_Tafoos[i + k + 1, j] == "X")
                                {
                                    if (best > 8)
                                    {
                                        best = 8;
                ...
                for (int j = 0; j < a_XOstatus3.GetLength(1); j++)
                {
                    ...
                    else if (!a_XOstatus3[i, j].Contains('X') && a_XOstatus3[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            if (a_Tafoos[i + k, j + k] == null)
                            {
                                         if (i + k + 1 < a_Tafoos.GetLength(0) && j + k + 1 < a_Tafoos.GetLength(0) && i + k - 1 >= 0 && j + k - 1 >= 0 && a_Tafoos[i + k + 1, j + k + 1] == "O" && a_Tafoos[i + k - 1, j + k - 1] == "O")
                                {
                                    if (best > 4)
                                    {
                                        best = 4;
                                ...
                                else if (i + k - 1 >= 0 && j + k - 1 >= 0 && a_Tafoos[i + k - 1, j + k - 1] == "O")
                                {
                                    if (best > 6)
                                    {
                                        best = 6;
                        ...
                        for (int k = 0; k < v_Sequence; k++)
                        {
                                ...
                                if (i + k + 1 < a_Tafoos.GetLength(0) && j + k + 1 < a_Tafoos.GetLength(0) && i + k - 1 >= 0 && j + k - 1 >= 0 && a_Tafoos[i + k + 1, j + k + 1] == "X" && a_Tafoos[i + k - 1, j + k - 1] == "X")
                            {
                                if (best > 7)
                                {
                                 ...
                                 else  if (i + k - 1 >= 0 && j + k - 1 >= 0 && a_Tafoos[i + k - 1, j + k - 1] == "X")
                                {
                                    if (best > 8)
                                    {
                                        best = 8;
                ...
                for (int j = 0; j < a_XOstatus6.GetLength(1); j++)
                {
                    ...
                    else if (!a_XOstatus6[i, j].Contains('X') && a_XOstatus6[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            if (a_Tafoos[i, j + k] == null)
                            {
                                          ...
                                          if (j + k + 1 < a_Tafoos.GetLength(1) && j + k - 1 >= 0 && a_Tafoos[i, j + k - 1] == "O" && a_Tafoos[i, j + k + 1] == "O")
                                {
                                    if (best > 4)
                                    {
                                        best = 4;
                                ...
                                else  if (j + k + 1 < a_Tafoos.GetLength(1) && a_Tafoos[i, j + k + 1] == "O")
                                {
                                    if (best > 6)
                                    {
                                        best = 6;
                    ...
                    else if (!a_XOstatus6[i, j].Contains('O') && a_XOstatus6[i, j].Length == v_Sequence - 2)
                    {
                        for (int k = 0; k < v_Sequence; k++)
                        {
                            if (a_Tafoos[i, j + k] == null)
                            {
                                      if (j + k + 1 < a_Tafoos.GetLength(1) && j + k - 1 >= 0 && a_Tafoos[i, j + k - 1] == "X" && a_Tafoos[i, j + k + 1] == "X")
                                {
                                    if (best > 7)
                                    {
                                        best = 7;
                              ...
                              else  if (j + k + 1 < a_Tafoos.GetLength(1) && a_Tafoos[i, j + k + 1] == "X")
                                {
                                    if (best > 8)
                                    {
                                        best = 8;
...
public void ResetPanelWithMessagebox(string s)
        ...
        private void resetPanel()
        {
         ...
         // ט. יציאה: הפונקצייה מוסיפה איקס או עיגול למערכי המונים לפי הפרמטרים שהתקבלו
         //ולפי התור
                ...
                if (x < ar2.GetLength(0) && y < ar2.GetLength(1) && x >= 0 && y >= 0)
                {
                    ...
                    if (sign != -1)//Adding Xs
                    {
                        ...
                        else if (Turn == 'O')
                        {
                            ...
                            ar2[x, y] += "O";
                            if (!dimion && ar2[x, y].Length == v_Sequence && !ar2[x, y].Contains("X"))
                            {
